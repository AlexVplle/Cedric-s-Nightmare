...
public class Parser 
{
     ...
     * @param pInputLine retrieve string from the terminal
     * @return Create command with string from the terminal
     */
    public Command getCommand(final String pInputLine) 
    {
        ...
        Command command = aCommandWords.get(vWord1);
        if (command != null) command.setSecondWord(vWord2);
        return command;
    } // getCommand(.)

    /**
     * Returns a String with valid command words.
     * @return String with valid command words.
     */
    public StringBuilder getCommandString() // was showCommands()
    {
